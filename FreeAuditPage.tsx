...
const FreeAuditPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault(); // send to Cloud Run first, then let Netlify handle its native submit
    ...
    try {
      ...
      // Now let Netlify process its own submission (recaptcha, submissions log, redirect)
      formEl.submit();
    }
  };
